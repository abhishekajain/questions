...
public class EmployeeDoublyLinkedList {
    ...
    public boolean addBefore(Employee newEmployee, Employee existingEmployee) {
    	...
    	EmployeeNode existingEmpNode = this.find(existingEmployee);
    	if(existingEmpNode != null) {
    		EmployeeNode newEmployeeNode = new EmployeeNode(newEmployee);
    		newEmployeeNode.setNext(existingEmpNode);
    		newEmployeeNode.setPrevious(existingEmpNode.getPrevious());
    		existingEmpNode.setPrevious(newEmployeeNode);
    ...
    private EmployeeNode find(Employee existingEmployee) {
